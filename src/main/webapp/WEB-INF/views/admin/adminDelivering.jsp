...
<div id="snb">
	<div class="snb_header ico_config">
		...
		<dl>
			...
			<dd class="o10 active"><a href="/admin/delivering">배송중</a></dd>		
	...
	<div id="content">
		<div class="breadcrumb">
            ...
            <ion-icon name="chevron-forward-outline"></ion-icon> 배송중		
        </div>
...
<h2>기본검색</h2>
<form action="/admin/delivering" name="fsearch" id="fsearch" method="get">
<div class="tbl_frm01">
	<table>
	<colgroup>
		<col class="w100">
...
<div class="tbl_head01">
	...
	<tbody>
		<c:forEach var="orderItem" items="${orderList}">
			<form action="/admin/modifyOrderStatus3" name="forderlist" id="forderlist" method="post">
			...
			<tr class="list0">
				...
				<td>
					<button type="button" id="" class="btn_lsmall">배송조회</button>
				</td>
				<td>
					<button type="submit" id="btn_modify" class="btn_lsmall">배송완료</button>
				</td>
			</tr>
			</form>
		</c:forEach>
