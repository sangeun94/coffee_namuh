...
<div id="snb">
	<div class="snb_header ico_config">
		...
		<dl>
	        ...
	        <dd class="o10 active"><a href="/admin/deliveryComplete">배송완료</a></dd>		
	...
	<div id="content">
		<div class="breadcrumb">
            ...
            <ion-icon name="chevron-forward-outline"></ion-icon> 배송완료		
        </div>
...
<h2>기본검색</h2>
<form action="/admin/deliveryComplete" name="fsearch" id="fsearch" method="get">
<div class="tbl_frm01">
	<table>
	<colgroup>
		<col class="w100">
	...
	<tbody>
		<c:forEach var="orderItem" items="${orderList}">
			...
			<tr class="list0">
				...
				<td>
					<button type="submit" id="btn_modify" class="btn_lsmall">구매확정</button>
				</td>
			</tr>
			</form>
		</c:forEach>
