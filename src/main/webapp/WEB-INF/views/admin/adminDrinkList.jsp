...
<form id="frm_customers" action="/admin/remove" method="post">
	...
	<div class="tbl_head02">
		...
		<tbody>
			<c:forEach var="menuItem" items="${menuList}">
				<tr class="list1">
				<td>
					<input type="checkbox" class="chb_checkNumber" name="faqNumber" value="${menuItem.menuNumber}">
				</td>
