...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<label><input type="radio" name="q_isopen" value="3"> 단종</label>
			<label><input type="radio" name="q_isopen" value="4"> 중지</label>
		</td>
...
<div class="local_frm01">
	...
	<a href="./goods.php?code=form" class="fr btn_lsmall red"><ion-icon name="add-outline"></ion-icon>상품등록</a>
</div>
...
<div class="tbl_head02">
	...
	<tbody>
		...
		<td >13</td>
		<td ><a href="" target="_blank"><img src="http://demofran.com/data/goods/1516934487/thumb-79666_Dqpxzw59F3Pzg9PrtDe9tSmaUCF7tu_40x40.jpg" width="40" height="40"></a></td>
		<td>1516934487</td>
		<td class="tal">[루이까또즈] 우븐 숄 머플러 인디라 와인 SA-2HW362WI</td>
		<td>진열</td>
		<td class="tar">39,600</td>
		<td class="tar">24,270</td>
		<td class="tar">31,560</td>
		<td class="tar">1,580</td>
		<td class="tar">1,580</td>
		<td><input type="text" name="" value="2" class="frm_input"></td>
		<td><a href="" class="btn_small">수정</a></td>
	</tr>
...
<div class="local_frm02">
	...
	<a href="./goods.php?code=form" class="fr btn_lsmall red"><ion-icon name="add-outline"></ion-icon> 상품등록</a></div>
</form>
