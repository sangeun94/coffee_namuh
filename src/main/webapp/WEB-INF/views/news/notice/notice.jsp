            ...
            <div class="cont_boxs text_center">
                            ...
                            <li>
                                <div class="board_search_wrap">
                                    <div class="board_search">
                                        <form>
                                            <input type="hidden" name="bbs_category" id="bbs_category" value="1">
                ...
                <div class="cont_text_wrap">
                                    ...
                                    <tbody>
                                                ...
                                                <td class="board_pc">815</td>
                                                        ...
                                                        <td>
                                                            <div class="text_wrap">
                                                                <div class="text">
                                                                    <a href="detail/?bbs_idx=199&bbs_category=1&bbs_detail_category=&bbs_page=1">
                                                                        <em>
                                                                            탄소중립실천포인트제 도입 안내																			</em>
                                                                    </a>
                                                                                                                                        </div>
                                                        ...
                                                        <td>
                                                            <div class="text_wrap">
                                                                <div class="text">
                                                                    <a href="detail/?bbs_idx=198&bbs_category=1&bbs_detail_category=&bbs_page=1">
                                                                        <em>
                                                                            메가MGC커피 영양성분표																			</em>
                                                                    </a>
                                                                                                                                        </div>
                        ...
                        <div class="board_page">
                            <ul>
                                <li class='fo_re'><a><span>처음</span></a></li><li class='board_page_check'><a><span>1</span></a></li><li><a><span>마지막</span></a></li>								</ul>
                        </div>
                    </div>
                </div>
            </div>
